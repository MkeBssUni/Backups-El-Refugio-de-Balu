...
CREATE TABLE `logs` (
  ...
  `type` enum('INSERT','UPDATE','DELETE','LOGIN','BLOCK','FAILED_LOGIN','UNBLOCK','CHANGE_STATUS') NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pets` (
  ...
  `life_stage` enum('BABY','YOUNG','ADULT','SENIOR') NOT NULL,
  ...
  `user_adoptant_id` bigint DEFAULT NULL,
  `category_id` bigint DEFAULT NULL,
  `user_moderator_id` bigint DEFAULT NULL,
  `user_owner_id` bigint DEFAULT NULL,
  `status_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKkxh1u76fr7ca45emtph6amosk` (`user_adoptant_id`),
  ...
  CONSTRAINT `FKkxh1u76fr7ca45emtph6amosk` FOREIGN KEY (`user_adoptant_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `statusses` VALUES (1,'ADOPTED'),(3,'APPROVED'),(4,'CLOSED'),(5,'IN_REVISION'),(2,'PENDING');
...
INSERT INTO `users` VALUES (1,NULL,0,0,NULL,'2024-04-01 21:53:43',NULL,'$2a$10$WEQb0HL.xX7dlXYCLgrYbOt4AWllLMyuYixx.XbasK0ZhznR.K5Y6',0,'XbQEsoVWjrzcOZKK3yE45fIUeGJZozr9+glYoLRRr2k=',2),(2,NULL,0,0,NULL,'2024-04-01 21:53:43',NULL,'$2a$10$mM1ewmqFNbOQ7.HP7hFHkOFMuUH/rooQhRimjbKYgrn4R0pS7XDAy',0,'CUljXPzOaHphYRXkEAcXj2TT89atg4RdCPXzwhspYqk=',1),(3,NULL,0,0,NULL,'2024-04-01 21:53:43',NULL,'$2a$10$1qwoSXEYW7IOuUV1HOgugeZA/8FnnXjNAZ12giZblDvW2GXYRWj9S',0,'2QRY9NPikhdt7Db3oZ0BcbG4ziroWAMRTJwQvVhkmts=',3);
...
-- Dump completed on 2024-04-02 17:16:57
